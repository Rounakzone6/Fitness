      ...
      <div className="relative z-10 flex flex-col items-center py-10 justify-center max-w-[95%] mx-auto">
        ...
        <ul className="flex gap-4 flex-wrap items-center justify-center">
          {classSchedule.map((item) => (
            <li
              className="p-3 flex gap-2 flex-col border-gray-400 shadow w-full md:w-[20vw] border rounded-lg hover:bg-white hover:text-black cursor-pointer transition-all duration-500"
              key={item.id}
            >
